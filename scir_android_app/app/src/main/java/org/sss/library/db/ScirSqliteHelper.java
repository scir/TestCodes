...
//        contentValues.put(COLUMN_ID,12345);
    ...
    public void insertSomeRecords() {
        insertMessage("DDDD", "S131345", "2016-12-09", 3.5f, 4.6f, 5500, "Sanity", "High");
        insertMessage("DDDD", "S135415", "2016-12-09", 3.5f, 4.6f, 55300, "Road", "High");
        insertMessage("DDDD", "S123542", "2016-12-11", 3.5f, 4.6f, 55600, "Electricity", "High");
        insertMessage("DDDD", "S135455", "2016-12-12", 3.5f, 4.6f, 15500, "Road", "High");
        insertMessage("DDDD", "S153545", "2016-12-09", 3.5f, 4.6f, 335500, "Sanity", "High");
    }
